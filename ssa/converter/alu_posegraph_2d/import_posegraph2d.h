...
namespace ssa {
  ...
  static void importPoseGraph2D(std::string logfile, SparseSurfaceAdjustmentGraph& ssaGraph);
  static void importRobotLaser(std::istream& is, g2o::VertexSE2* parent, SparseSurfaceAdjustmentGraph& ssaGraph);
